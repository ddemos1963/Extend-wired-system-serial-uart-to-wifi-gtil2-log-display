...
IPAddress local_IP(192, 168, 0, 253); // IP address of ESP device
IPAddress gateway(192, 168, 0, 1); // IP of Gateway
...
// Web Page Heading
            client.println("<body></h2><font color=blue><h1>GTIL2 Inverter Readings</h2>");
            
// Display current readings 
            client.print(F("<p><h2><font size=4><font color=black>Line Voltage: "));
            client.print(VAC, 1);
            client.print(F(" VAC"));
            client.println(F("</font></h2></p>"));

            client.print(F("<p><h2><font size=4><font color=black>Output Power: "));
            ...
            client.print(F("<p><h2><font size=4><font color=black>Solar Panel Voltage: "));
            client.print(VDC, 1);
            client.print(F(" VDC"));
            client.println(F("</font></h2></p>"));
